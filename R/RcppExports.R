...
sampleLocalFCI <- function(true_dag, df, targets, names, lmax = 3L, signif_level = 0.01, verbose = TRUE, estDAG = FALSE) {
    .Call(`_LocalFCI_sampleLocalFCI`, true_dag, df, targets, names, lmax, signif_level, verbose, estDAG)
}

popLocalFCI <- function(true_dag, targets, names, lmax = 3L, verbose = TRUE) {
    .Call(`_LocalFCI_popLocalFCI`, true_dag, targets, names, lmax, verbose)
}

sampleLocalPC <- function(true_dag, df, targets, names, lmax = 3L, signif_level = 0.01, verbose = TRUE, estDAG = FALSE) {
    .Call(`_LocalFCI_sampleLocalPC`, true_dag, df, targets, names, lmax, signif_level, verbose, estDAG)
}

popLocalPC <- function(true_dag, targets, names, lmax = 3L, verbose = TRUE) {
    .Call(`_LocalFCI_popLocalPC`, true_dag, targets, names, lmax, verbose)
}
